import MarketChallengeImplementation from './implementations/market';
...
export default function Market() {
  return(
    <>
      ...
      <p>
        When a buy order has a price above a sell order, the quantity of each diminishes until one of the quantities goes to 0, and thus the order is fulfilled.
        <br />
      </p>
      <ol>
        <li>The UI should allow generating orders of any kind and process the input</li>
        <li>The UI can be very simple but must show the best bid and best offer (the price to buy and the price to sell) correctly at any point</li>
      </ol>
      <MarketChallengeImplementation />
    </>
  )
}
